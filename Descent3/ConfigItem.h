...
public:
	...
	//create functions
	bool Create(NewUIGameWindow *parentwnd,int type,char *label,int x,int y,int w,int h,int initialvalue,int flags,int item_x);
	bool Create(NewUIGameWindow *parentwnd,int type,char *label,int x,int y,int w,int h,bool initialvalue,int flags,int item_x);
	bool Create(NewUIGameWindow *parentwnd,int type,char *label,int x,int y,int w,int h,float initialvalue,int flags,int item_x);
