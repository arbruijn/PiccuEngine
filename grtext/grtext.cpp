...
inline int CHAR_WIDTH(int font, int ch)
{
	return (int)(grfont_GetCharWidth(font, ch) * Grtext_scale);
}

inline int CHAR_HEIGHT(int font)
{
	return (int)(grfont_GetHeight(font) * Grtext_scale);
}

inline int CHAR_SPACING(int font, int ch1, int ch2)
{
